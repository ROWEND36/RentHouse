...
<body>
  ...
  <div class="container">
    <div class="row justify-content-center text-center m-2 pb-4" id="collapseParent">
      <div class="col-md-4 card collapse show" id="login-card" data-parent="#collapseParent">
        <div class="card-body">
          <h4>Login in as Administrator</h4>
          <form method="post" action="/webapi/handle_login.php" class="form-inline justify-content-center mb-4">
          ...
          <span class="">Don't Have An Account? <a class="" data-toggle="collapse" href="#sign-up-card" data-parent="#collapseParent" role="button" aria-expanded="false" aria-controls="sign-up-card">
              Sign up
            </a>
            instead</span><br />
      ...
      <div class="card col-md-4 collapse" id="sign-up-card" data-parent="#collapseParent">
        <div class="card-body">
          <h4>Sign up as Administrator</h4>
          <form method="post" action="/webapi/handle_signup.php" class="form-inline justify-content-center mb-4">
            <input type="email" required name="email" id="email" Placeholder="Email" size="40" class="form-control p-2 mx-1 my-2">
            <input type="password" required name="password" id="password" Placeholder="Password" size="40" minlength=8 class="form-control p-2 mx-1 my-2">
            ...
            <input type="password" required name="api_key" id="api_key" Placeholder="Enter Api Key" size="40" minlength=8 class="form-control p-2 mx-1 my-2">

            <input type="submit" value="Sign Up" class="btn btn-danger px-4 py-2">
          </form>
          <span class="">Already Have An Account? <a class="" data-toggle="collapse" href="#login-card" data-parent="#collapseParent" role="button" aria-expanded="true" aria-controls="login-card">
              Log in
            </a>
            instead</span>
      ...
      <div class="card col-md-4 collapse" id="forgot-password" data-parent="#collapseParent">
        <div class="card-body">
          ...
          <form method="post" action="/webapi/send_password.php" class="form-inline justify-content-center mb-4">
            <input type="email" required name="email" id="email" Placeholder="Email" size="40" class="form-control p-2 mx-1 my-2">
            <input type="submit" value="Send Email" class="btn btn-danger px-4 py-2">
          </form>
          <span class=""><a class="" data-toggle="collapse" href="#login-card" data-parent="#collapseParent" role="button" aria-expanded="true" aria-controls="login-card">
              Back To Log in
            </a></span>
        </div>
      </div>
  ...
  <footer>
    <div class="section-5 text-center position-absolute" style="left:0;right:0;bottom:0;">
      <hr>
